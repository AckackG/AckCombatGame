...
- [x] 滚轮缩放视角，重置视角
- [x] 右键移动视角
- [x] RTS :左键框选，右键行动，被框选后单位，30秒内不会自行移动。
- [x] 战役模式：完善刷怪波数，让游戏能玩起来
- [x] 数据展示：展示枪械数据
...
- [ ] **武器距离重做**，2倍range开火，3.5倍rang子弹消失，0.7倍range后退，武器range2属性覆盖消失距离
- [ ] **子弹随着距离伤害衰减曲线**，1倍 range 以上开始衰减，直到3.5倍极限距离的25%
